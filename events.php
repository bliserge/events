...
<body>
    ...
    <div class="w-container" style="width:2000px;">
        <div class="row">
            <?php
            $result = mysqli_query($conn, "SELECT * FROM events WHERE status!= 0 ");
                    ...
                    <div class="title">
                            ...
                            if (isset($_SESSION['mail'])) {
                               ?>
                                ...
                                onclick="op('<?php echo $eventid; ?>','<?php echo $normal ?>','<?php echo $vip; ?>','<?php echo $rn; ?>','<?php echo $rv; ?>')">BUY
                                Ticket</button>
                               <?php
                            } else {
                               ?>
