    ...
    <div class="col-md-4">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo " href="dashboard.php"><img class="img-avatar"
            style="height: 70px; width: auto;" src="assets/img/companyimages/logo2.png" alt=""></a>
        ...
        if ($query->rowCount() > 0) {
          foreach ($results as $row) {
            if ($row->role == "admin") {
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu  navbar-dropdown" aria-labelledby="dropdown05">
                  <a class="dropdown-item" href="new_bookings.php">New Tickets</a>
                  <a class="dropdown-item" href="approved_bookings.php">Approved Tickets</a>
                  <a class="dropdown-item" href="cancelled_bookings.php">Cancelled Tickets</a>
                </div>
            </li>
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="dropdown05" data-toggle="dropdown" aria-haspopup="true"
              ...
              <li class="nav-item dropdown">
                <a class="nav-link" href="organizers.php">Manage organizers</a>
              </li>
              <li class="nav-item dropdown">
                <a class="nav-link" href="agents.php">Manage Agents</a>
              </li>
              <?php
            }
            elseif($row->role== "organizer")
            {
              ...
              <li class="nav-item dropdown">
                <a class="nav-link" href="manage_event.php">Agent Asignment</a>
              </li>
              <?php
            ...
            elseif($row->role= "agent")
            {
              ...
              <li class="nav-item dropdown">
                <a class="nav-link" href="manage_event.php">Incident Reporting</a>
              </li>
            ...
            else
            {
              ?>
                 <li class="nav-item dropdown">
                  ...
                  <a class="dropdown-item" href="../">No permission found go home</a>
