        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="new_bookings.php">New Tickets</a></li>
                    <li class="nav-item"> <a class="nav-link" href="approved_bookings.php">Approved Tickets</a></li>
                    <li class="nav-item"> <a class="nav-link" href="cancelled_bookings.php">Cancelled Tickets</a></li>
                </ul>
            </div>
        </li>
