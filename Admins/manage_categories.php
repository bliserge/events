...
if(isset($_GET['delid']))
{
  ...
  $sql="delete from eventcategories where ID=:rid";
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="modal-header">
                  <h5 class="modal-title" style="float: left;">Event categories Registry</h5>    
                  <div class="card-tools" style="float: right;">
                    <button type="button" class="btn btn-sm btn-info" data-toggle="modal" data-target="#addsector" ><i class="fas fa-plus" ></i> Add Category
                    </button>
                  </div>    
                </div>
                ...
                <div class="modal fade" id="addsector">
                  <div class="modal-dialog modal-md ">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h4 class="modal-title">Register Event Categories</h4>
                      ...
                      {    
                        ...
                        <tr>
                          ...
                          <td class="text-center">
                            <span class=""><?php  echo htmlentities(($row->	recomended));?></span>
                          </td>
                          <td class="text-center">
                            ...
                            <a href="manage_categories.php?delid=<?php echo ($row->id);?>" onclick="return confirm('Do you really want to Delete ?');" class="btn btn-danger rounded"><i class="mdi mdi-delete" aria-hidden="true"></i></a>
                          </td>
