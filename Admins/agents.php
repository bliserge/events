                        ...
                        foreach ($results as $row) {
                          ...
                          <tr>
                            ...
                            <td class="text-center">
                              ...
                              <a href="assign.php?agentid=<?php echo ($row->ID); ?>" class="rounded btn btn-info"><i
                                  class="mdi mdi-eye" aria-hidden="true"></i></a>

                              <a href="editevent.php?id=<?php echo ($row->ID); ?>" class="rounded btn btn-info"><i
                                  class="mdi mdi-pen" aria-hidden="true"></i></a>
