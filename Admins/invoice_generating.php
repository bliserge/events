            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                ...
                <div class="table-responsive p-3">
                  <?php
                  $invid=$_GET['invid'];
                  $sql="SELECT tblbooking.BookingID,tblbooking.Name,tblbooking.MobileNumber,tblbooking.Email,tblbooking.EventDate,tblbooking.EventStartingtime,tblbooking.EventEndingtime,tblbooking.VenueAddress,tblbooking.events,tblbooking.AdditionalInformation,tblbooking.BookingDate,tblbooking.Remark,tblbooking.Status,tblbooking.UpdationDate,eventcategories.ServiceName,eventcategories.SerDes,eventcategories.ServicePrice from tblbooking join eventcategories on tblbooking.ServiceID=eventcategories.ID  where tblbooking.ID=:invid";
