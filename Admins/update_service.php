...
if(isset($_POST['submit']))
{
  ...
  $price=$_POST['price'];
  $sql="update eventcategories set category =:servicename,description=:servicedes,recomended=:price  where eventcategories.id=:eid";
...
<div class="card-body">
  ...
  <form class="forms-sample" method="post" enctype="multipart/form-data" class="form-horizontal">
    <?php
    $eid=$_POST['edit_id'];
    $sql="SELECT * from  eventcategories where eventcategories.ID=:eid";
    $query = $dbh -> prepare($sql);
    $query-> bindParam(':eid', $eid, PDO::PARAM_STR);
    $query->execute();
